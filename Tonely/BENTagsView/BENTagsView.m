...
- (void)baseInit
{
	...
	self.offColor = [UIColor blackColor];
	self.font = [UIFont systemFontOfSize:9];
	self.textColor = [UIColor colorWithRed:186/225.0f green:190/225.0f blue:228/225.0f alpha:1.0f];
...
- (void)refresh
{
	...
	for (BENTag *tag in self.tags)
	{
		...
		{
			[self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[previousTag]-3-[tag]"
																		 options:0
																		 metrics:nil
