...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
	{
		...
		[self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-10-[label]-10-|"
																	 options:0
																	 metrics:nil
																	   views:views]];
		[self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-1-[label]-3-|"
																	 options:0
																	 metrics:nil
																	   views:views]];
